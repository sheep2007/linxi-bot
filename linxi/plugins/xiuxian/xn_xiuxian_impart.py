...
class XIUXIAN_IMPART_BUFF:
    ...
    def add_impart_atk_per(self, impart_num, user_id):
        ...
        cur = self.conn.cursor()
        sql = (
            f"UPDATE xiuxian_impart SET impart_atk_per=impart_atk_per+? WHERE user_id=?"
        )
        cur.execute(sql, (impart_num, user_id))
        self.conn.commit()
        return True
    ...
    def add_impart_mix_per(self, impart_num, user_id):
        ...
        cur = self.conn.cursor()
        sql = (
            f"UPDATE xiuxian_impart SET impart_mix_per=impart_mix_per+? WHERE user_id=?"
        )
        cur.execute(sql, (impart_num, user_id))
        self.conn.commit()
        return True
    ...
    def add_impart_two_exp(self, impart_num, user_id):
        ...
        cur = self.conn.cursor()
        sql = (
            f"UPDATE xiuxian_impart SET impart_two_exp=impart_two_exp+? WHERE user_id=?"
        )
        cur.execute(sql, (impart_num, user_id))
        self.conn.commit()
        return True
