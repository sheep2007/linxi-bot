...
msg_pass = {
    ...
    4: [
        "奇遇的降临让你获得了荒天帝的精血传承，一股力量涌入，头脑中突然符文密布，随机迸发了出来，环绕着你的身体。"
...
msg_died = {
    ...
    4: [
        "空间破碎，只听见一句“仙之巅，傲世间，有我安澜便有天。”你便被一只手掌抓入了空间裂隙中，败了\n",
        "奇遇降临，你本想向前去查看，但你却在看见裂隙中隐隐约约中" "看见了那位的身影，你一股热血涌入心头，离开时虚神界，败了\n",
    ],
    5: [
        "见空间不稳定，随机便用出了空间秘术，准备踏空间而去，但你进入空间裂隙之后，却发现裂隙在一点点破碎，仿佛将要不存在了一样，你顿时就好像明白了什么，但转眼间"
        "便消亡了，败了\n",
                ...
                list_msg.append(
                    {
                        "type": "node",
                        "data": {
                            "name": f"第{str(x + 1)}回合道友 {player_1_name}行动",
                            "uin": player_1,
                            "content": txt,
                        },
                    }
                ...
                list_msg.append(
                    {
                        "type": "node",
                        "data": {
                            "name": f"第{str(x + 1)}回合道友 {player_2_name}行动",
                            "uin": player_2,
                            "content": txt,
                        },
                    }
