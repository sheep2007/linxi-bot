...
CONFIG = {
    ...
    "Boss灵石": {
        ...
        "祭道之上": [1000000000, 1400000000, 1960000000],
    },
    "Boss名字": ["金凰儿", "九寒", "莫女", "术方", "卫起", "血枫", "衣以候", "以向"],  # 生成的Boss名字，自行修改
    "Boss个数上限": 15,
    "Boss倍率": {
    ...
    "Boss生成时间参数": {"hours": 0, "minutes": 50},  # Boss生成的时间，每1小时5分钟生成一只，2个不可全为0
    "世界积分商品": {
        "1": {"id": 1999, "cost": 1000, "desc": "渡厄丹,使下一次突破丢失的修为减少为0!"},
        "2": {"id": 4003, "cost": 500, "desc": "陨铁炉,以陨铁炼制的丹炉,耐高温,具有基础的炼丹功能"},
        "3": {
            "id": 4002,
            "cost": 2500,
            "desc": "雕花紫铜炉,表面刻有精美雕花的紫铜丹炉,一看便出自大师之手,可以使产出的丹药增加1枚",
        },
        "4": {"id": 4001, "cost": 10000, "desc": "寒铁铸心炉,由万年寒铁打造的顶尖丹炉,可以使产出的丹药增加2枚"},
        "5": {"id": 2500, "cost": 500, "desc": "一级聚灵旗,提升洞天福地中的灵气汇集速度,加速修炼速度和灵田中药材生长速度"},
        "6": {
            "id": 2501,
            "cost": 1000,
