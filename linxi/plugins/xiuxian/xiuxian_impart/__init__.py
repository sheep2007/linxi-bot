...
from ..utils import check_user, get_msg_pic, send_forward_msg_list, CommandObjectID
...
impart_data = on_command(
    "传承信息", aliases={"我的传承信息", "我的传承"}, priority=10, permission=GROUP, block=True
)
