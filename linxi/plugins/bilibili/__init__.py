...
__plugin_meta__ = PluginMetadata(
    ...
    config=Config,
    extra={
        "unique_name": "bilibili",
        "example": "/bili 关注动态 2019044357"
    }
)
...
follow_liver_command = on_command("bili 关注主播", aliases={"bili follow_anchor"}, permission=ALL_PERMISSION)
...
unfollow_liver_command = on_command("bili 取关主播", aliases={"bili unfollow_anchor"}, permission=ALL_PERMISSION)
...
listFollowingCommand = on_command("bili 查询关注", aliases={"bili 查询成分", "bili list"}, permission=ALL_PERMISSION)
...
followUpCommand = on_command("bili 关注up", aliases={"bili 关注UP", "bili follow_up"}, permission=ALL_PERMISSION)
...
unfollowUpCommand = on_command("bili 取关up", aliases={"bili 取关UP", "bili unfollow_up"}, permission=ALL_PERMISSION)
...
followTelegramCommand = on_command("bili 关注番剧", aliases={"bili follow_anime"}, permission=ALL_PERMISSION)
...
unfollowTelegramCommand = on_command("bili 取关番剧", aliases={"bili unfollow_anime"}, permission=ALL_PERMISSION)
...
follow_dynamic_command = on_command("bili 关注动态", aliases={"bili follow_action"}, permission=ALL_PERMISSION)
...
unfollow_dynamic_command = on_command("bili 取关动态", aliases={"bili unfollow_action"}, permission=ALL_PERMISSION)
